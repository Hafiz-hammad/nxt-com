...
import { APP_NAME, AVAILABLE_DELEVERY_DATES, AVAILABLE_PAYMENT_METHODS, DEFAULT_PAYMENT_METHOD } from '@/lib/constant'
                ...
                <div className='col-span-5'>
                  <p>
                    Delivery date:{' '}
                    {
                      formatDateTime(
                        calculateFutureDate(
                          AVAILABLE_DELEVERY_DATES[deliveryDateIndex].daysToDelevery
                        )
                      ).dateOnly
                    }
                  </p>
                    ...
                    <p className='mb-2'>
                      <span className='text-lg font-bold text-green-700'>
                        Arriving{' '}
                        {
                          formatDateTime(
                            calculateFutureDate(
                              AVAILABLE_DELEVERY_DATES[deliveryDateIndex!]
                                .daysToDelevery
                            )
                          ).dateOnly
                        }
                      ...
                      <div>
                        <div className=' font-bold'>
                          ...
                          <ul>
                            <RadioGroup
                              value={
                                AVAILABLE_DELEVERY_DATES[deliveryDateIndex!].name
                              }
                              onValueChange={(value) =>
                                setDeliveryDateIndex(
                                  AVAILABLE_DELEVERY_DATES.findIndex(
                                    (address) => address.name === value
                                  )!
                                )
                              }
                            >
                              {AVAILABLE_DELEVERY_DATES.map((dd) => (
